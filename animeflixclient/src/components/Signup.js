...
function Signup() {
  ...
  const [credentials, setc] = useState({ email: "", username: "", password: "" });
        ...
        <main className="form-signin w-100 m-auto">
          <div className='overlay my-5 p-3'>
            <form onSubmit={handleSubmit}>
              ...
              <button className=" btn btn-primary w-75 m-auto py-2 d-flex justify-content-center" type="submit">Sign Up</button>
            </form>
          </div>
        </main>
      </div>
