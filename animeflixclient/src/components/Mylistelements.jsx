  ...
  return (
    ...
    <div className="card shadow-lg p-3 mb-5" style={{width: "16rem"}}>
        ...
        <div className="card-body">
          ...
          {(!submit&&!er)&&<button type="submit" onClick ={onClick} className="btn btn-primary">Remove from List</button>}
          {submit&&<div className="alert alert-primary " role="alert">Removed Successfully!!</div>}
