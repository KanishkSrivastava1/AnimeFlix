                ...
                <h1 className='d-flex justify-content-center my-2'>Search Anime</h1>
                    ...
                    <form className='w-50 mw-550 d-flex justify-content-center m-auto'>
                        <div className="input-group mb-3 my-5 mw-550 m-auto d-flex justify-content-center ">
                            <input type="text" className="form-control border-white" value={text} onChange={handleOnchange} placeholder="Title" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                            <button className="btn btn-outline-secondary border-white" type="button" onClick={handleClick}>
